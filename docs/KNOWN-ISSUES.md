...
upstream — see [`docs/upstream-cloudron-backup-syncer-race.md`](upstream-cloudron-backup-syncer-race.md)
(forum link to be added once filed). The permanent package-side fix lands in **v0.2.0**
